...
import { UpdateTransaksiPembelian, TampilTransaksiPembelian, DeleteTransaksipembelian } from './buttons';
        ...
        <div className="rounded-lg bg-green-100 p-4 shadow-md">
              ...
              >
                ...
                <div className="flex items-center justify-between pt-4">
                  ...
                  <div className="flex gap-2">
                    <TampilTransaksiPembelian id={tpe.id_transaksi_pembelian} />
                    <DeleteTransaksipembelian id={tpe.id_transaksi_pembelian} />
                  </div>
                </div>
              </div>
            ))}
          ...
          <table className="hidden min-w-full md:table bg-green-50 rounded-lg">
            <thead className="bg-green-600 text-white text-sm font-medium rounded-t-lg">
              <tr>
                <th scope="col" className="px-4 py-3 text-left">Nama Supplier</th>
